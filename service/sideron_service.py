...
class SideronServiceServer:
    ...
    def run(
        ...
        print(
            " SideronService V2 - Mode développement"
        )
        print(
            "========================================"
        )
        ...
        try:
            ...
            response = (
                ServiceResponse(
                    success=False,
                    message=(
                        "Requête SideronService invalide."
                    ),
                    error_code=(
                        "INVALID_REQUEST"
                    ),
    ...
    def _handle_ping(
        ...
        return ServiceResponse(
            success=True,
            message=(
                "SideronService répond correctement."
            ),
            data={
                "service": (
                    "SideronService"
    ...
    def _protected_process_response(
        ...
        return ServiceResponse(
            ...
            message=(
                ...
                "pas être arrêté par SideronService."
            ),
            error_code=(
                "PROTECTED_PROCESS"
            ),
