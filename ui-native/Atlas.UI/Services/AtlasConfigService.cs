...
public sealed class AtlasConfigService
{
    ...
    public AtlasConfig Load()
    {
        ...
        {
            UiLog.Error(
                "Atlas configuration load failed.",
                exception);
    ...
    public AtlasUpdateConfiguration LoadUpdateConfiguration()
    {
        var path =
            EnsureRuntimeConfig();
        ...
        if (path is null)
        {
            return AtlasUpdateConfiguration.Default;
        }
        ...
        try
        {
            ...
            return new AtlasUpdateConfiguration(
                version,
                enabled,
                channel,
                checkOnStartup,
        ...
        {
            UiLog.Error(
                "Atlas update configuration load failed.",
                exception);
    ...
    public AtlasUpdateConfiguration SaveUpdateChannel(
        string requestedChannel)
    {
        ...
        var runningChannel = GetReleaseChannel(GetRunningAtlasVersion());
    ...
    private static string GetRunningAtlasVersion()
    {
        try
        {
            var assembly =
                typeof(AtlasConfigService)
                    .Assembly;
        ...
        {
            UiLog.Error(
                "Unable to resolve running Atlas version.",
                exception);
        }
        ...
        string channel)
    {
        ...
        return
            ...
            + "Jexodi/Atlas/main/updates/manifests/"
            + manifestName;
    }
        ...
        AtlasConfig config)
    {
        ...
        UiLog.Info(
            $"Atlas configuration saved: {path}");
    }
    ...
    private static string? EnsureRuntimeConfig()
    {
        ...
        try
        {
            ...
            UiLog.Info(
                $"Atlas runtime configuration initialized: {runtimePath}");
    ...
    private static string? FindInstalledAtlasConfig()
    {
        var explicitRoot =
...
public sealed record AtlasUpdateConfiguration(
    string Version,
    bool Enabled,
    string Channel,
    bool CheckOnStartup,
    string ManifestUrl)
{
    public static AtlasUpdateConfiguration Default { get; } =
        new(
            "Inconnue",
            true,
            "release",
