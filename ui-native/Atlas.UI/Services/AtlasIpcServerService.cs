...
public sealed class AtlasIpcServerService
    : IDisposable
{
        ...
        object? payload = null)
    {
        ...
        UiLog.Info(
            $"IPC Atlas.UI -> Core: command={name}, sent={sent}");
        ...
        CancellationToken cancellationToken)
    {
        ...
        )
        {
            ...
            try
            {
                ...
                UiLog.Info(
                    "Atlas.UI IPC waiting for Core on both pipes.");
                ...
                UiLog.Info(
                    "Atlas Core connected to Atlas.UI IPC (2 pipes).");
        ...
        string line)
    {
        try
        {
            ...
            UiLog.Info(
                $"IPC Core -> Atlas.UI: type={type ?? "-"}, name={name ?? "-"}");
    ...
    private void SetDisconnected()
    {
        ...
        {
            UiLog.Info(
                "Atlas Core disconnected from Atlas.UI IPC.");
